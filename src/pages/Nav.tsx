...
class Nav extends React.Component {
  render(){
    return (
      <div className="fixed top-0 left-0 m-0 p-0 z-40 w-full h-screen -translate-x-full bg-white/30 dark:bg-black/30" id="menuBack">
        <div className="w-64 p-4 bg-white dark:bg-zinc-900 h-screen transition-transform -translate-x-full">
