...
export class DashboardComponent {
  ...
  links: Array<DashboardLink> = [
    ...
    { title: 'CSV visualizer in Table', url: 'csv_to_table', icon: ['https://cdn-icons-png.flaticon.com/512/1126/1126902.png'] },
    { title: 'JSON visualizer in Table', url: 'json_to_table', icon: ['https://cdn-icons-png.flaticon.com/512/136/136525.png'] },
    { title: 'XML visualizer in Table', url: 'xml_to_table', icon: ['https://cdn-icons-png.flaticon.com/512/136/136526.png'] },
    ...
    { title: 'Convert JSON to XML', url: 'json_to_xml', icon: ['https://cdn-icons-png.flaticon.com/512/136/136525.png', 'https://cdn-icons-png.flaticon.com/512/466/466154.png', 'https://cdn-icons-png.flaticon.com/512/136/136526.png'] },
    { title: 'Convert XML to JSON', url: 'xml_to_json', icon: ['https://cdn-icons-png.flaticon.com/512/136/136526.png', 'https://cdn-icons-png.flaticon.com/512/466/466154.png', 'https://cdn-icons-png.flaticon.com/512/136/136525.png'] },
    { title: 'Convert JSON to XLS', url: 'json_to_xls', icon: ['https://cdn-icons-png.flaticon.com/512/136/136525.png', 'https://cdn-icons-png.flaticon.com/512/466/466154.png', 'https://cdn-icons-png.flaticon.com/512/8263/8263105.png'] },
    { title: 'Convert XLS to JSON', url: 'xls_to_json', icon: ['https://cdn-icons-png.flaticon.com/512/8263/8263105.png', 'https://cdn-icons-png.flaticon.com/512/466/466154.png', 'https://cdn-icons-png.flaticon.com/512/136/136525.png'] },
    { title: 'Convert XML to XLS', url: 'xml_to_xls', icon: ['https://cdn-icons-png.flaticon.com/512/136/136526.png', 'https://cdn-icons-png.flaticon.com/512/466/466154.png', 'https://cdn-icons-png.flaticon.com/512/8263/8263105.png'] },
    { title: 'Convert XLS to XML', url: 'xls_to_xml', icon: ['https://cdn-icons-png.flaticon.com/512/8263/8263105.png', 'https://cdn-icons-png.flaticon.com/512/466/466154.png', 'https://cdn-icons-png.flaticon.com/512/136/136526.png'] },
  ];
